...
macro_rules! generate_tests {
    ($hash_type:ty) => {
        ...
        /// - Assert that the resource retrieved by path matches the expected
        ///   resource.
        ...
        fn test_build_index_with_empty_file() {
            let temp_dir =
                TempDir::with_prefix("ark_test_build_index_with_empty_file")
                    .expect("Failed to create temp dir");
            let root_path = temp_dir.path();
        ...
        /// - Assert that the resource retrieved by path for each file matches
        ...
        /// - Build a resource index in the temporary directory.
        /// - Assert that the index contains two entries.
        /// - Assert that the resources retrieved by path for each file match
